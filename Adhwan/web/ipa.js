...
let adhwanInput = document.querySelector("#lexicon input[name='adhwan']");

adhwanInput.addEventListener('input', function () {
  console.log(this.value);
  let entry = adhwanInput.value;
  let pron = ipa(entry);
  document.getElementById('adhword-ipa').innerHTML = pron;
});
